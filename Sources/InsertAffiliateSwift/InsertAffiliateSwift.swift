...
public struct InsertAffiliateSwift {
    ...
    private static func reportSdkInitIfNeeded(companyCode: String, verboseLogging: Bool) {
        ...
        Task {
            do {
                guard let url = URL(string: "https://324f86ccc627.ngrok-free.app/V1/onboarding/sdk-init") else {
                    return
                }
    ...
    private static func reportAffiliateAssociationIfNeeded(affiliateIdentifier: String, source: AffiliateAssociationSource) {
        Task {
            ...
            guard let url = URL(string: "https://324f86ccc627.ngrok-free.app/V1/onboarding/affiliate-associated") else {
                return
            }
    ...
    public static func setInsertAffiliateIdentifier(
        ...
        if #available(iOS 13.0, *) {
            Task {
                ...
                let urlString = "https://324f86ccc627.ngrok-free.app/V1/convert-deep-link-to-short-link?companyId=\(companyCode)&deepLinkUrl=\(encodedAffiliateLink)"
    ...
    internal static func fetchOfferCode(affiliateLink: String, completion: @Sendable @escaping (String?) -> Void) async {
        ...
        let offerCodeUrlString = "https://324f86ccc627.ngrok-free.app/v1/affiliateReturnOfferCode/\(companyCode)/\(encodedAffiliateLink)?platformType=\(platformType)"
    ...
    public static func trackEvent(eventName: String) async {
        ...
        let apiUrlString = "https://324f86ccc627.ngrok-free.app/v1/trackEvent"
    ...
    public static func storeExpectedAppStoreTransaction(userAccountToken: UUID) async {
        ...
        let apiUrlString = "https://324f86ccc627.ngrok-free.app/v1/api/app-store-webhook/create-expected-transaction"
        guard let apiUrl = URL(string: apiUrlString) else {
            print("[Insert Affiliate] Invalid API URL")
            return
        }
    ...
    public static func getAffiliateDetails(affiliateCode: String) async -> AffiliateDetails? {
        ...
        let urlString = "https://324f86ccc627.ngrok-free.app/V1/checkAffiliateExists"
